                  ...
                  topCourses.map((item, index) => (
                    <div key={index} className="flex items-center justify-between p-3 border rounded-lg">
                      ...
                      <div className="text-right">
                        <div className="font-semibold">₹{item.revenue.toLocaleString('en-IN')}</div>
                        <Badge variant="outline">₹{(item.course?.price || 0).toLocaleString('en-IN')} each</Badge>
                      </div>
                    </div>
                  ))
                ) : (
          ...
          <Card>
            ...
            <CardContent>
              {enrollments.length > 0 ? (
                ...
                <p className="text-center text-gray-500 py-4">No enrollment data available</p>
              )}
            </CardContent>
          </Card>
        </div>
