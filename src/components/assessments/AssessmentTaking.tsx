...
const AssessmentTaking = ({ assessmentId }: AssessmentTakingProps) => {
  ...
  const fetchAssessmentData = async () => {
    try {
      ...
      // Calculate total marks from questions if assessment total_marks is null
      ...
      const passingMarks = assessmentData.passing_marks || Math.ceil(totalMarks * 0.6); // 60% default
