...
import { CheckCircle, Clock, Book, Target, Download } from "lucide-react";
...
const CareerRoadmapModal = ({ isOpen, onClose, careerPath }: CareerRoadmapModalProps) => {
  ...
  const handleStartLearning = () => {
    ...
    toast({
      ...
      description: `Browse our courses to begin your ${careerPath} journey.`,
    });
  };

  const handleDownloadRoadmap = () => {
    // Create a text content for the roadmap
...
Visit us at: ${window.location.origin}
    ...
    a.href = url;
    a.download = `${careerPath.replace(/\s+/g, '_')}_Roadmap.txt`;
    ...
    toast({
      ...
      description: `Your ${careerPath} roadmap has been saved to your device.`,
    });
  };
